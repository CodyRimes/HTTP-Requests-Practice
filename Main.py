...
# The API we will be using will be coming from https://httpbin.org/
# Common HTTP Methods:
...
dataPayloadToSendInPostHTTPRequest = {'username':'Cocksucker', 'password':'Jynx Maze'}
responseObjectForPostRequest = requests.post('https://jsonplaceholder.typicode.com/posts', dataPayloadToSendInPostHTTPRequest)
print(responseObjectForPostRequest)
